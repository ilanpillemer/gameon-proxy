...
./docker run -d -p 80:80 -p 443:443 -p 1936:1936 -p 4002:4002 -e LOGSTASH_ENDPOINT=$LOGSTASH_ENDPOINT -e ADMIN_PASSWORD=$ADMIN_PASSWORD -e PROXY_DOCKER_HOST=$PROXY_DOCKER_HOST --name=gameon-proxy gameon-proxy
